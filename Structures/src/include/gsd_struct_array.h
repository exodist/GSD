...
result array_set_ref   (array *a, int64_t idx, reference *val);
result array_update_ref(array *a, int64_t idx, reference *val);
result array_insert_ref(array *a, int64_t idx, reference *val);
...
int64_t array_push_ref   (array *a, reference *val);
int64_t array_unshift_ref(array *a, reference *val);

result array_cmp_update    (array *a, int64_t idx, void *val);
result array_cmp_update_ref(array *a, int64_t idx, reference *val);
